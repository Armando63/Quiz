...
namespace Quiz
{
	public partial class Inicio : Form
	{
		...
		private void btnIndividual_Click_1(object sender, EventArgs e)
		{
			...
			// CORRECCIÓN #6: Validar que el jugador se registró correctamente
			if (idJugadorGlobal <= 0)
			{
				MessageBox.Show("Error al registrar jugador. Verifica la conexión a la base de datos.",
		...
		private void btnMultijugador_Click_1(object sender, EventArgs e)
		{
			...
			// CORRECCIÓN #5: Pedir IP del servidor al jugador
			string ip = Microsoft.VisualBasic.Interaction.InputBox(
				"Ingresa la IP del servidor\n(El host puede verla con 'ipconfig' en cmd):",
			...
			SalaMultijugador sala = new SalaMultijugador(ip);
			sala.Show();
			this.Hide();
		}
